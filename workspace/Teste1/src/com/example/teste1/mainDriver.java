...
public class mainDriver extends Activity implements Callback {
	...
	public List<BluetoothGattCharacteristic> lstCharacteristics = new ArrayList<BluetoothGattCharacteristic>();
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
            	...
            	if (characteristic.getUuid().equals(UUID_DEVICE_NAME)) {
            		...
            		msg = "Revolucoes: " + characteristic.getUuid().toString() +"="+ String.valueOf(status);
            		Log.d(MAIN_DRIVER, "STRING=" + characteristic.getStringValue(0));
            		Log.d(MAIN_DRIVER, "UINT16=" + characteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT16, 0) + ";");
            		...
            		Log.d(MAIN_DRIVER, "Preferred Parameters=" + characteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT16, 0) + ";");
            		...
            		Log.d(MAIN_DRIVER, "SensorLocation=" + characteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT16, 0));
            	} else {
