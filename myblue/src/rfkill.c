				...
				GIOCondition cond, gpointer data)
{
	...
	{
	    printf("Event Soft or Hard\n");
	    return TRUE;
	}

    printf("Event Op %d (Should be %d)", event->op, RFKILL_OP_CHANGE);

	if (event->op != RFKILL_OP_CHANGE)
	{
	    printf("Kill Op Change\n");
	    return TRUE;
	}


    printf("Event Type %d (Should be %d or %d)", event->type, RFKILL_TYPE_BLUETOOTH, RFKILL_TYPE_ALL);
