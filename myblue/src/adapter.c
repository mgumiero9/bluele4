...
static int adapter_register(struct btd_adapter *adapter)
{
    ...
    printf("Registering Adapter - before powering down\n");
					...
					const void *param, void *user_data)
{
    ...
    printf("Calling adapter_register\n");
							...
							void *user_data)
{
    ...
    printf("sending read info command for index %u", index);
					...
					const void *param, void *user_data)
{
	...
	printf("read_index_list_complete\n");
...
int adapter_init(void)
{
    ...
    printf("adapter_init - setting debug\n");
